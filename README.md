...
- 如果Kimi的结果已经出来了，那么可以参考Kimi的总结，结合自己的经验，再思考一下这篇论文是否真的值得收藏；
- 如果觉得这篇论文并不如期望，那么可以点击标题右端的星星，取消星标；
- 如果觉得论文值得收藏，可以点击[PDF]，然后右上角有个下载按钮，可以下载论文，或者点击论文左上角的带#数字，跳转到Arxiv原始页面（比如需要Arxiv Id）；
- 如果觉得论文值得分享，可以点击[Copy]，那么论文的相关信息会被复制到粘贴板，你可以到你要分享的位置进行粘贴；
