...
### 2024.05.05
- **增加全站论文搜索**：试上线全站论文搜索功能，搜索本地收录的所有论文，这是基于倒排索引和BM25的搜索引擎，由[tantivy](https://tantivy-py.readthedocs.io/en/latest/)搭建，目前只支持搜索title和summary两个字段，没有高级的自定义功能，后期看用户反馈再斟酌补充自定义选项。
